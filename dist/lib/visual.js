...
export async function takeScreenshot(url, outPath, viewport = { width: 1366, height: 768 }) {
...
export function compareImages(basePngBuffer, comparePngBuffer, diffOutPath) {
