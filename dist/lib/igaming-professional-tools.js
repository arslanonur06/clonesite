...
export async function performRiskAssessment(playerId, domains = []) {
...
export async function performKYCVerification(playerId) {
...
export async function performAMLMonitoring(playerId, timeframe = '30d') {
...
export async function monitorTransactions(playerId, timeframe = '24h') {
...
export async function manageLoyaltyPrograms(action = 'list') {
...
export async function analyzeChargebackPrevention(timeframe = '30d') {
...
export async function verifyGameFairness(gameId) {
...
export async function performPlayerSegmentation(criteria = 'value') {
