...
export async function compareWebsites(url1, url2) {
    ...
    try {
        ...
        const overallSimilarity = (visualSimilarity.similarity * 0.4 +
...
export async function compareMultipleWebsites(urls) {
    console.log(`🔍 Comparing ${urls.length} websites...`);
    const comparisons = [];
    const potentialClones = [];
...
async function analyzeVisualSimilarity(screenshot1, screenshot2) {
...
function analyzeDOMSimilarity(html1, html2) {
...
function analyzeTextSimilarity(html1, html2) {
...
function calculateCosineSimilarity(map1, map2) {
