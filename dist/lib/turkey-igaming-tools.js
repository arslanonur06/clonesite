...
// ============================================================================
export async function monitorBTKCompliance(brand, domains = []) {
...
// ============================================================================
export async function analyzeTurkishPaymentMethods(brand, targetUrl) {
...
// ============================================================================
export async function checkKVKKCompliance(brand, domains = []) {
...
export async function monitorTurkishDomains(brand) {
    ...
    for (let i = 0; i < Math.min(variants.length, 40); i++) {
        ...
        if (isActive)
            activeDomains.push(domainInfo);
        if (isBlocked)
            blockedDomains.push(domainInfo);
...
// ============================================================================
export async function monitorTurkishSocialMedia(brand) {
...
// ============================================================================
export async function analyzeTurkishMarket(brand) {
...
// ============================================================================
export async function monitorTurkishAdvertising(brand) {
...
// ============================================================================
export async function monitorTurkishSportsBetting(brand) {
...
// ============================================================================
export async function analyzeTurkishRevenue(brand) {
...
// ============================================================================
export async function generateTurkeyComprehensiveReport(brand) {
    ...
    const overallRiskScore = Math.floor((btk.summary.complianceScore * 0.2 +
...
// Helper Functions
// ============================================================================
function generateTurkishDomainVariants(brand) {
    const variants = [];
    const suffixes = [
