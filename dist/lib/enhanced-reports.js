...
class EnhancedReportGenerator {
    ...
    async generateReport(data, templateId = 'executive-summary', format = 'pdf') {
    ...
    generateSectionHTML(section, data, template) {
        switch (section) {
            case 'summary':
    ...
    generateSummarySection(data, template) {
        return `
      <div class="section">
    ...
    generateRiskOverviewSection(data, template) {
    ...
    generateDomainAnalysisSection(data, template) {
    ...
    generateWhoisDetailsSection(data, template) {
        if (!data.whois || data.whois.length === 0)
            return '';
        return `
      <div class="section">
    ...
    generateAhrefsMetricsSection(data, template) {
        if (!data.ahrefs || data.ahrefs.length === 0)
            return '';
        return `
      <div class="section">
    ...
    generateThreatIntelligenceSection(data, template) {
    ...
    generateKeyFindingsSection(data, template) {
    ...
    generateRecommendationsSection(data, template) {
    ...
    generateHeaderHTML(data, template) {
        return `
      <div class="header">
        <h1>${template.name}</h1>
    ...
    generateFooterHTML(data, template) {
        return `
      <div class="footer">
    ...
    generateRegulatoryOverviewSection(data, template) {
        return `
      <div class="section">
    ...
    generateDomainComplianceSection(data, template) {
        return `
      <div class="section">
    ...
    generateLegalActionsSection(data, template) {
        return `
      <div class="section">
    ...
    generateAuditTrailSection(data, template) {
        return `
      <div class="section">
        <h2>📝 Audit Trail</h2>
    ...
    generateDomainThreatsSection(data, template) {
        return this.generateDomainAnalysisSection(data, template);
    }
    generateCloneDetectionSection(data, template) {
        return `
      <div class="section">
    ...
    generateSocialMediaSection(data, template) {
        return `
      <div class="section">
    ...
    generateMobileAppsSection(data, template) {
        return `
      <div class="section">
