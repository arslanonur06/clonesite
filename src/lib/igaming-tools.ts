...
export async function monitorAffiliateLinks(brand: string, officialAffiliateIds: string[] = []) {
...
export async function verifyGamingLicenses(domains: string[]) {
...
export async function analyzePaymentMethods(domains: string[]) {
...
export async function verifyGameProviders(domains: string[]) {
...
export async function checkResponsibleGaming(domains: string[]) {
...
export async function detectBonusAbuse(brand: string) {
...
export async function checkGeoCompliance(domains: string[], restrictedRegions: string[] = ['US', 'AU', 'FR', 'IT']) {
...
export async function detectOddsManipulation(brand: string) {
...
export async function analyzeCustomerSupport(domains: string[]) {
...
export async function analyzeGamingSecurity(domains: string[]) {
...
export async function generateDMCARequests(suspiciousAffiliates: any[], brandName: string) {
  ...
  for (const affiliate of suspiciousAffiliates) {
    if (!affiliate.hostingInfo) continue;
...
function generateDMCALetter(params: any) {
...
async function sendDMCAEmail(dmcaRequest: any) {
...
export async function generateComprehensivePDFReport(data: any, outputPath: string) {
...
export async function generateAffiliatePDFReport(data: any, outputPath: string) {
...
export async function generateLicenseVerificationPDFReport(data: any, outputPath: string) {
...
export async function generatePaymentAnalysisPDFReport(data: any, outputPath: string) {
...
export async function generateResponsibleGamingPDFReport(data: any, outputPath: string) {
...
export async function generateSecurityAnalysisPDFReport(data: any, outputPath: string) {
...
function generateAffiliateReportHTML(data: any) {
...
function generateLicenseReportHTML(data: any) {
...
function generateResponsibleGamingReportHTML(data: any) {
  const { brand, domains, results } = data;
...
function generateSecurityReportHTML(data: any) {
  const { brand, domains, results } = data;
...
export async function analyzeWebsiteInDepth(url: string, brand: string) {
...
async function analyzePageContent(page: any, brand: string) {
...
function calculateRiskScore(analysis: any, brand: string) {
  let riskScore = 0;
  let reasons = [];
  
  // Brand impersonation
  const totalBrandMentions = analysis.brandMentions.reduce((sum: number, mention: any) => sum + mention.mentions, 0);
  ...
  const highBonuses = analysis.bonusOffers.filter((offer: any) => offer.suspicious).length;
  if (highBonuses > 2) {
    riskScore += 20;
  ...
  const suspiciousAffiliates = analysis.affiliateLinks.filter((link: any) => link.suspicious).length;
...
function extractContextAroundBrand(text: string, brand: string): string[] {
  const contexts = [];
