...
export async function searchAppStore(brand: string, platform: 'ios' | 'android'): Promise<MobileApp[]> {
...
export async function compareAppIcons(originalIconUrl: string, suspiciousIconUrl: string): Promise<number> {
  try {
...
export async function monitorMobileApps(brand: string, originalIconUrl?: string): Promise<MobileApp[]> {
